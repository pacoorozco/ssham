# Contribueix al codi d'aquesta aplicació
...
* **SSHAM Version(s)** - is it a regression?
...
* Search [GitHub](https://github.com/pacoorozco/ssham/pulls) for an open or closed Pull Request
...
we use the git commit messages to **generate the SSHAM change log**.
...
[github]: https://github.com/pacoorozco/ssham
