                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    ...
                                    <div id="import_public_key_form">
                                        {!! Form::textarea('public_key', null, array('class' => 'form-control' . ($errors->has('public_key') ? ' is-invalid' : ''), 'id' => 'public_key', 'rows' => '5', 'required' => 'required')) !!}
                                        <span class="form-text text-muted">
                                            @lang('key/messages.import_public_key_help')
                                        </span>
                                        @error('public_key')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
