...
<div class="row">
    <div class="col-xs-6">
        ...
        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
            {!! Form::label('name', __('usergroup/model.name'), array('class' => 'control-label')) !!}
            <div class="controls">
        ...
        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
            {!! Form::label('description', __('usergroup/model.description'), array('class' => 'control-label')) !!}
            <div class="controls">
    ...
    <div class="col-xs-6">
        ...
        <div class="form-group {{ $errors->has('users[]') ? 'has-error' : '' }}">
            {!! Form::label('users[]', __('usergroup/model.users'), array('class' => 'control-label')) !!}
            <div class="controls">
                @if (isset($usergroup))
...
@section('scripts')
    ...
    <script>
        $(".search-select").select2({
            placeholder: "@lang('usergroup/messages.users_placeholder')",
            allowClear: true,
