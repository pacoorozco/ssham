            ...
            <div class="tab-content">
                <div class="tab-pane in active" id="panel_settings_tab1">
                    ...
                    <div class="form-group {{ $errors->has('private_key') ? 'has-error' : '' }}">
                        {!! Form::label('private_key', __('settings/model.private_key'), array('class' => 'control-label')) !!}
                        <div class="controls">
                    ...
                    <div class="form-group {{ $errors->has('public_key') ? 'has-error' : '' }}">
                        {!! Form::label('public_key', __('settings/model.public_key'), array('class' => 'control-label')) !!}
                        <div class="controls">
                    ...
                    <div class="form-group {{ $errors->has('ssh_port') ? 'has-error' : '' }}">
                        {!! Form::label('ssh_port', __('settings/model.ssh_port'), array('class' => 'control-label')) !!}
                        <div class="controls">
                    ...
                    <div class="form-group {{ $errors->has('ssh_timeout') ? 'has-error' : '' }}">
                        {!! Form::label('ssh_timeout', __('settings/model.ssh_timeout'), array('class' => 'control-label')) !!}
                        <div class="controls">
                ...
                <div class="tab-pane" id="panel_settings_tab2">
                    ...
                    <div class="form-group {{ $errors->has('ldap_host') ? 'has-error' : '' }}">
                        {!! Form::label('ldap_host', __('settings/model.ldap_host'), array('class' => 'control-label')) !!}
                        <div class="controls">
                    ...
                    <div class="form-group {{ $errors->has('ldap_dn') ? 'has-error' : '' }}">
                        {!! Form::label('ldap_dn', __('settings/model.ldap_dn'), array('class' => 'control-label')) !!}
                        <div class="controls">
                ...
                <div class="tab-pane" id="panel_settings_tab3">
                    ...
                    <div class="form-group {{ $errors->has('mixed_mode') ? 'has-error' : '' }}">
                        {!! Form::label('mixed_mode', __('settings/model.mixed_mode'), array('class' => 'control-label')) !!}
                        <div class="controls">
                            {!! Form::select('mixed_mode', array('1' => __('general.yes'), '0' => __('general.no')), Registry::get('mixed_mode'), array('class' => 'form-control')) !!}
                    ...
                    <div class="form-group {{ $errors->has('authorized_keys') ? 'has-error' : '' }}">
                        {!! Form::label('authorized_keys', __('settings/model.authorized_keys'), array('class' => 'control-label')) !!}
                        <div class="controls">
                    ...
                    <div class="form-group {{ $errors->has('ssham_file') ? 'has-error' : '' }}">
                        {!! Form::label('ssham_file', __('settings/model.ssham_file'), array('class' => 'control-label')) !!}
                        <div class="controls">
                    ...
                    <div class="form-group {{ $errors->has('non_ssham_file') ? 'has-error' : '' }}">
                        {!! Form::label('non_ssham_file', __('settings/model.non_ssham_file'), array('class' => 'control-label')) !!}
                        <div class="controls">
                    ...
                    <div class="form-group {{ $errors->has('cmd_remote_updater') ? 'has-error' : '' }}">
                        {!! Form::label('cmd_remote_updater', __('settings/model.cmd_remote_updater'), array('class' => 'control-label')) !!}
                        <div class="controls">
