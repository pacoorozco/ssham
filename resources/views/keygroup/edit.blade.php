...
@section('content')
    ...
    <div class="card">
        ...
        <x-forms.form :action="route('keygroups.update', $keygroup)" method="PUT">
            ...
            <div class="form-row">
                ...
                <div class="col-md-4">
                    ...
                    <fieldset>
                        ...
                        <!-- name -->
                        <x-forms.input name="name" :label="__('keygroup/model.name')" :default="$keygroup->name" required autofocus>
                            @slot('help')
                        ...
                        <!-- description -->
                        <x-forms.textarea name="description" :label="__('keygroup/model.description')" :default="$keygroup->description">
                            @slot('help')
                                <small class="form-text text-muted">
                ...
                <div class="col-md-8">
                    ...
                    <fieldset>
                        ...
                        <!-- key groups -->
                        <x-forms.select name="keys[]" :label="__('keygroup/model.hosts')" :options="$keys" multiple class="duallistbox" :default="$keygroup->keys->pluck('id')">
                            @slot('help')
                                <small class="form-text text-muted">
