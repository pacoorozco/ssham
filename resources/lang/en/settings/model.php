...
return [
    ...
    */
    ...
    'ssh_port' => 'Default SSH remote port',
    ...
    'authorized_keys' => 'Default authorized keys file',
    'authorized_keys_help' => 'Default path where SSHAM will generate authorized keys file on remote hosts.',
